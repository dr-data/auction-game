document.addEventListener('DOMContentLoaded', function() {
    const gameData = [
        ...
        },
        {
            ...
            "Arist Name": "Pierre-Auguste Renoir",
    ...
    function calculateScore(userGuess, originalPrice) {
        ...
        document.getElementById('user-guess-value').textContent = guess.toFixed(2);
        document.getElementById('gain-loss-value').textContent = difference.toFixed(2);
        document.getElementById('cumulative-difference-value').textContent = cumulativeDifference.toFixed(2);
        document.getElementById('gain-loss-info').style.display = 'block';  // Show the gain/loss info
